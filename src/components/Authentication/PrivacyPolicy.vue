        ...
        <div class="important-container">
            ...
            <div class="important-block">
                <div class="important-block__text-container">
                    <p class="important-block__title">
                    ...
                    <p class="important-block__text">
                        ...
                        предпринимаемые Белан Дианой Валерьевной (далее — Оператор).<br />
                        ...
                        получить о посетителях веб-приложения https://dicardz.com/.<br />
                        ...
                        2.3. Веб-приложение — совокупность графических и информационных материалов,
                        а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети
                        интернет по сетевому адресу https://dicardz.com/ .<br />
                        ...
                        к определенному или определяемому Пользователю веб-приложения
                        ...
                        2.10. Пользователь — любой посетитель веб-приложения https://dicardz.com/
                        .<br />
                        ...
                        направление требования о прекращении обработки персональных данных;<br />
                        ...
                        содержащимся в веб-приложении<br />
                        ...
                        или обязательному раскрытию в соответствии с федеральным законом.<br />
                        ...
                        для исполнения обязательств по гражданско-правовому договору.<br />
                        ...
                        уведомление на адрес электронной почты Оператора Dianeb@yandex.ru с пометкой
                        ...
                        почты на электронный адрес Оператора Dianeb@yandex.ru с пометкой «Отзыв
                        ...
                        Оператору с помощью электронной почты Dianeb@yandex.ru.<br />
