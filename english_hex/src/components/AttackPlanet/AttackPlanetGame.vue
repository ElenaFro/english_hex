...
async function fetchQuestions() {
    try {
        const token =
            'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vNjIuMTA5LjAuMjI1OjgwMDAvYXBpL2xvZ2luIiwiaWF0IjoxNzUwNzQzMjE4LCJleHAiOjE3NTg1MTkyMTgsIm5iZiI6MTc1MDc0MzIxOCwianRpIjoiZ21uVFpGM2dKMkVMeU0wcCIsInN1YiI6IjIiLCJwcnYiOiIyM2JkNWM4OTQ5ZjYwMGFkYjM5ZTcwMWM0MDA4NzJkYjdhNTk3NmY3In0.36MM59TNLhHSVA5zvJhdQQMdcW0gci9hbSkiASLppc0'; // Замените на ваш токен
