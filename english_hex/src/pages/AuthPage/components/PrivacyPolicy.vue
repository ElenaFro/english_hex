    ...
    <q-card class="auth-card q-pa-md">
        <q-card-section>
            ...
            <q-card-section class="message-block q-pa-md">
                <div class="text-h6 q-mb-sm">Политика в отношении обработки персональных данных</div>
                <p class="text-body1">
                    ...
                    персональных данных, предпринимаемые Белан Дианой Валерьевной (далее — Оператор).<br>
                    ...
                    применяется ко всей информации, которую Оператор может получить о посетителях веб-приложения
                    https://dicardz.com/.<br>
                    ...
                    2.3. Веб-приложение — совокупность графических и информационных материалов, а также программ для ЭВМ
                    и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://dicardz.com/
                    .<br>
                    ...
                    определяемому Пользователю веб-приложения https://dicardz.com/.<br>
                    ...
                    Цель обработки<br>
                    предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся в
                    веб-приложении<br>
                    Персональные данные<br>
                    ...
                    Dianeb@yandex.ru с пометкой «Актуализация персональных данных».<br>
                    ...
                    Оператору уведомление посредством электронной почты на электронный адрес Оператора Dianeb@yandex.ru
                    ...
                    его персональных данных, обратившись к Оператору с помощью электронной почты Dianeb@yandex.ru.<br>
